...
export const ACHIEVEMENTS = [
  ...
  { id: 'formula-all',      icon: '🧮', title: 'Formula God',       desc: 'Master all 36 math formulas in MathFlash' },
...
const CHECKS = {
  ...
  'formula-all':  () => { try { const v = JSON.parse(localStorage.getItem('sat_prep_math_flash') ?? '{}'); return Object.values(v).filter(p => p.mastered).length >= 36 } catch { return false } },
