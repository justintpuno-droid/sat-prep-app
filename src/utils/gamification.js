...
export const ACHIEVEMENTS = [
  ...
  { id: 'vocab-all',        icon: '🎓', title: 'Word Master',       desc: 'Master all 93 SAT vocabulary words' },
...
const CHECKS = {
  ...
  'vocab-all':    () => { try { const v = JSON.parse(localStorage.getItem('sat_prep_vocab') ?? '{}'); return Object.values(v).filter(p => p.mastered).length >= 93 } catch { return false } },
