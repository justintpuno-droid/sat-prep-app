...
function getHint(achId, stats, gam) {
  ...
  switch (achId) {
    ...
    case 'vocab-all':       return h('Vocab words mastered', stats.vocabMastered, 280)
    ...
    case 'vocab-200':       return h('Vocab words mastered', stats.vocabMastered, 280)
    ...
    case 'vocab-221':
    case 'vocab-king':     return h('Vocab words mastered', stats.vocabMastered, 280)
